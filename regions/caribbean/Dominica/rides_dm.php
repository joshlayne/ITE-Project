...
<html>
    <head>
        ...
        <title>islandMovers - Dominica</title>
                ...
                <div class="contact-con">
                    ...
                    <div class="contact-form" id="myForm">
                        <form action="./php/customer_check.php" method="post" class="form-container">
                            ...
                            <input type="text" name="phone" id="phone" placeholder="(767) ###-####" required>
        ...
        <div class="footer-2">
            <div class="contact-box2" style="clear: both; width:100%; ">
                ...
                <div class="info" style="display:flex;">
                    <div style="width:32%;"><p style="text-align: center;">(767) 000-0000</p> </div>
                    <div style="width:32%;"><p style="text-align: center;">islandmoversdm@gmail.com</p></div>
                    <div style="width:32%;"><p style="text-align: center;"><img src="../../../assets/13.png" alt="Instagram icon" style="width:21px; height:21px"> @islandmoversdm</p></div>
                </div>
            </div>
        </div>
