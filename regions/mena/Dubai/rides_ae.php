...
<html>
    <head>
        ...
        <title>islandMovers - Dubai</title>
        ...
        <div class="footer-2">
            <div class="contact-box2" style="clear: both; width:100%; ">
                ...
                <div class="info" style="display:flex;">
                    <div style="width:32%;"><p style="text-align: center;">(971) 04 000-0000</p> </div>
                    <div style="width:32%;"><p style="text-align: center;">islandmoversae@gmail.com</p></div>
                    <div style="width:32%;"><p style="text-align: center;"><img src="../../../assets/13.png" alt="Instagram icon" style="width:21px; height:21px"> @islandmoversae</p></div>
                </div>
            </div>
        </div>
