...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 05, 2024 at 06:54 PM
...
--
-- Database: `islandmovers_barbados`
--
...
(1, 1, 'Sarah', 'Brown', 'sarah@example.com', '1234567890'),
(2, 1, 'Michael', 'Lee', 'michael@example.com', '9876543210'),
(3, 1, 'Emily', 'Davis', 'emily@example.com', '5551234567');
...
(4, 1, 1, '2024-02-12 08:15:00', 'Shared'),
(5, 2, 2, '2024-02-12 10:45:00', 'Not shared'),
(6, 3, 3, '2024-02-12 12:50:00', 'Shared');
...
CREATE TABLE IF NOT EXISTS `partners` (
  ...
  `PartnerLocation` varchar(255) DEFAULT NULL,
...
INSERT INTO `partners` (`PartnerID`, `PartnerName`, `PartnerLocation`, `ContactPerson`, `Email`, `Phone`, `ContractStartDate`, `ContractEndDate`) VALUES
(1, 'IslandBop', 'Bridgetown', 'Michael Clark', 'michael@example.com', '1234567890', '2024-01-01', '2024-12-31'),
(2, 'IslandBop', 'Holetown', 'Emily White', 'emily@example.com', '9876543210', '2024-02-01', '2024-12-31'),
(3, 'IslandBop', 'Oistins', 'David Brown', 'david@example.com', '5551234567', '2024-01-15', '2024-12-31');
...
(2, 1, 'Tuesday Discount', 'discount', '5.00', 'Tuesday', '2024-01-01 00:00:00', '2024-12-31 00:00:00');
...
(1, 1, 1, 'ABC Street', 'XYZ Street', '2024-02-12 08:00:00', 'Completed', '20.00'),
(2, 2, 2, 'DEF Road', 'GHI Avenue', '2024-02-12 10:30:00', 'Pending', NULL),
(3, 3, 3, 'JKL Lane', 'MNO Boulevard', '2024-02-12 12:45:00', 'Completed', '15.00');
...
(7, 1, 1, 'John', 'Doe', 'john@example.com', '1234567890', 'Bridgetown'),
(8, 1, 2, 'Alice', 'Smith', 'alice@example.com', '9876543210', 'Holetown'),
(9, 1, 3, 'Bob', 'Johnson', 'bob@example.com', '5551234567', 'Oistins');
...
(1, 'Sedan', 'ABC123', 'Red', 2020, 1),
(2, 'SUV', 'XYZ789', 'Blue', 2019, 1),
(3, 'Hatchback', 'DEF456', 'Black', 2021, 1);
